...
export function ServicesPage() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 leading-relaxed mb-8">
                We are dedicated to providing specialised Home care and Supported Living Services. For clients aged 18 and over, we offer a variety of services to ensure they are able to maintain as much autonomy as possible in their daily lives.
              </p>
            ...
            <div className="hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1576765608532-0739c148fd07?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHw3fHxjYXJlZ2l2ZXJ8ZW58MHx8fHwxNzcxNTQ1NjQxfDA&ixlib=rb-4.1.0&q=80&w=1080"
      ...
      <section id="domiciliary-care" className="py-24 bg-gray-50 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {domiciliaryServices.map((service) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-4 lg:p-6 rounded-2xl transition-all duration-300 flex items-center space-x-4 border-l-4 ${
                      isActive 
                  ...
                  >
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors ${
                      isActive ? 'bg-[#FFBD31] text-[#0F4C5C]' : 'bg-gray-100 text-gray-400'
                    }`}>
                      <Icon size={24} />
                    </div>
                    ...
                    <ChevronRight 
                      className={`ml-auto flex-shrink-0 transition-transform ${
                        isActive ? 'text-[#FFBD31] rotate-90 lg:rotate-0' : 'text-gray-300'
                      }`} 
                    />
                  </button>
                );
      ...
      <section id="supported-living" className="py-24 bg-white scroll-mt-20">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <div className="rounded-2xl overflow-hidden shadow-xl mb-8 border-4 border-gray-50">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1606335543042-57c525922933?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdXBwb3J0ZWQlMjBsaXZpbmd8ZW58MHx8fHwxNzcxNTQ1ODc0fDA&ixlib=rb-4.1.0&q=80&w=1080"
      ...
      <section className="py-24 bg-gradient-to-r from-[#0F4C5C] to-[#16697A] text-center text-white">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-xl text-gray-200 mb-10">
            Contact us today to book a free assessment and discover how our Domiciliary Care and Supported Living services can provide peace of mind to you and your family.
          </p>
          <Link
            to="/contact"
